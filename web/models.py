...
class Host(models.Model):
    ...
    # remote_users = models.ManyToManyField
...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    def get_full_name(self):
        #return user is indentified by their email address
        return self.email
...
class AuditLog(models.Model):
    """存储审计日志"""
    user = models.ForeignKey("UserProfile", verbose_name="堡垒机账号", on_delete=models.CASCADE, blank=True, null=True)
